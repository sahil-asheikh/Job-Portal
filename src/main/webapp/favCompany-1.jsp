...
<html>
    ...
    <body>
        ...
        <%
            ...
            ArrayList<TblJobActivity> act = jobAct.selectByCandidate(String.valueOf(session.getAttribute("CandidateId")));
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-hover table-fw-widget" id="table3">
                                        ...
                                        <tbody>
                                            <tr colspan="2">
                                                ...
                                                <td>
                                                    <div class="button-group">
                                                        ...
                                                        <a href="applyNow.jsp?id=<%= bean.getId()%>">Apply Now</a>
                                            ...
                                            <tr>
                                                <td>Java Intern</td>
                                                <td>Qaswa Technologies Pvt Ltd - Nagpur, Maharashtra</td>
                                                <td>Moved to saved 2 days ago</td>
                                                <td>Application viewed 7 days ago</td>
                                                <td>
                                                    <div class="button-group">
