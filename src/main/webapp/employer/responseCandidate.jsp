...
<!--                                                          <a href="../EmployerController?action=downloadResume&cid=<%= beanCandidate.getFullName() %>">
                                                            Resume
                                                            </a>-->
<!--                                                             <div class="icon-container">
                                                                <a  href="E:\JP\NikitaGalani.docx" title="Resume download" download>
                                                                 <div class="icon"><span class="mdi mdi-case-download"></span></div>
                                                                     </a>
                                                                 </div>
                    -->
                                                            <a href="/C:\Users\Nikita\Documents\NetBeansProjects\Resume.pdf" download>Download</a>
                                                        </button>
