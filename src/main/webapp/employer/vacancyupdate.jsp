                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group pt-2">
                                                    ...
                                                    <input class="form-control form-control-sm" id="txtTitle" type="text" name="txtTitle" value="<%= vacancy.getTitle()%>" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group pt-2">
                                                    <label for="txtNoOfOpening">No.of Openings</label>
                                                    <input class="form-control form-control-sm" id="txtNoOfOpening" type="number" name="txtNoOfOpening" value="<%= vacancy.getNoOfOpening()%>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-sm" id="txtMinSalary" type="number" name="txtMinSalary" value="<%= vacancy.getMinSalary()%>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="txtMaxSalary">Maximum Salary</label>
                                                    <input class="form-control form-control-sm" id="txtMaxSalary" type="number" name="txtMaxSalary" value="<%= vacancy.getMaxSalary()%>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id ="sts" name ="txtJobInState" class="form-control form-control-sm" required value="<%= vacancy.getJobState()%>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" required name="txtJobInCity" value="<%= vacancy.getJobCity()%>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 offset-0">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control form-control-sm" id="txtJobInArea" name="txtJobInArea" ><%= vacancy.getJobArea()%></textarea>                                        
                                                </div>
                                            </div>
                                        </div>                                    
                                </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="slEnglishAccuracy" name="txtEnglishAccuracy" value="<%= vacancy.getEnglishAccuracy()%>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="tags form-control form-control-sm" multiple="" id="slSkillSet" name="txtSkillSet" value="<%= vacancy.getSkillSet()%>">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control form-control-sm" id="txtJobDescription" name="txtJobDescription" ><%= vacancy.getJobDescription()%></textarea>                                              
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="form-row pt-2">
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control form-control-sm" id="txtJobTimings"  name="txtJobTiming" ><%= vacancy.getJobTiming()%></textarea>
                                        </div>
                                        <div class="col-md-6">                                         
                                            <label for="">Interview Details</label>
                                            <textarea class="form-control form-control-sm" id="txtInterviewDetails"  name="txtInterviewDetail" ><%= vacancy.getInterviewDetails()%></textarea>                                               
                                        </div>
                                    </div>  
                                </div>
                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-sm" id="txtCompanyName" type="text" name="txtCompanyName" value="<%= vacancy.getCompanyName()%>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="txtContactPerson">Contact Person</label>
                                                <input class="form-control form-control-sm" id="txtContactPerson" type="text" name="txtContactPerson" value="<%= vacancy.getContactPerson()%>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-sm" id="txtPhoneNumber" type="number" name="txtPhoneNumber" value="<%= vacancy.getPhoneNo()%>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="txtEmailId">Email Id</label>
                                                <input class="form-control form-control-sm" id="txtEmailId" type="email" name="txtEmailId" value="<%= vacancy.getEmailId()%>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 offset-0">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control form-control-sm" id="txtJobAddress" name="txtJobAddress" ><%= vacancy.getJobAddress()%></textarea>                                        
                                            </div>
                                        </div>
                                            <div class="col-sm-6">
                                                <p class="mt-8">
