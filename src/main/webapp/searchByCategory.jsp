...
<%
            ...
            ArrayList<TblVacancy> vacc = vacmod.searchByCategory("%"+(request.getParameter("category"))+"%");
    ...
    <%   for (TblVacancy vacancy : vacc) {
                    ...
                    <div class="col-lg-6">
                        <div class="card card-border-color card-border-color-primary">
                            <a href="jobsSearch.jsp"> <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-border-color card-border-color-primary">
                            ...
                            <a href="jobsSearch.jsp?id=<%= vacancy.getId() %> "><div class="card-body">
                                <div class="form-group row">
                                    <div class="col-12">
