...
<%
    ...
    ArrayList<TblVacancy> vacc = vacmod.searchByCategory("%" + (request.getParameter("title")) + "%", Integer.parseInt(request.getParameter("minID")), Integer.parseInt(request.getParameter("maxID")));
%>
...
<%
    int totalPageCategory = vacmod.totalPageCategory((request.getParameter("category")));
