...
<%@page import="com.qt.jobportal.beans.TblAdmin"%>
            ...
            <div class="main-content container-fluid">
              ...
              <%
                    AdminModel admModel=new AdminModel();
                     TblAdmin beanAdm=admModel.selectById(String.valueOf(session.getAttribute("AdminId")));
                                ...
                                <div class="user-display">
                                    ...
                                    <div class="user-display-bottom">
                                        ...
                                        <div class="user-display-info">
                                            <div class="name"> <%= session.getAttribute("AdminName")%></div>
                                                ...
                                                <table class="no-border no-strip skills">
                                                    <tbody class="no-border-x no-border-y">
                                                        <tr>
                                                            ...
                                                            <td class="item">Phone number<span class="icon s7-portfolio"></span></td>
                                                            <td><%= beanAdm.getPhoneNo()%></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="icon"><span class="mdi mdi-email"></span></td>
                                                            <td class="item">Email Id<span class="icon s7-gift"></span></td>
                                                            <td><%= beanAdm.getEmailId()%></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="icon"><span class="fa fa-key"></span></td>
                                                            <td class="item">Password<span class="icon s7-global"></span></td>
                                                            <td><%= beanAdm.getPassword()%></td>
                                                            <td><spam class="offset-5"><a  type="button" href="updatePassword.jsp?id=<%= session.getAttribute("AdminId")  %> ">Change Password</a></spam></td>
