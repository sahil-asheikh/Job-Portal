    ...
    <head>
        ...
        <script>
            function empViewDetails(id) {
                ...
                xhttp.open("GET", "empViewDetail.jsp?id=" + id, true);
                xhttp.send();
        ...
        <script>
            function empWalletDetails(id) {
                ...
                xhttp.open("GET", "employerWallet.jsp?id=" + id, true);
                xhttp.send();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-space">
                                                        <a href="#" class="btn btn-primary mr-1" data-toggle="modal" data-target="#exampleModal" onclick="empViewDetails('<%= employer.getCompanyPublicId()%>');"> <div class="icon-sm"><span class="mdi mdi-eye"></span></div></a>
                                                        <a class="btn btn-danger mr-5" href="../EmployerController?action=delete&eid=<%= employer.getCompanyPublicId()%>" onclick="return confirmDelete();"><div class="icon-sm"><span class="mdi mdi-delete"></span></div></a>

                                                        <a href="employerVacancy.jsp?id=<%= employer.getCompanyPublicId()%>" class="btn btn-primary mr-1" > Vacancy</a>
                                                        <a class="btn  btn-warning " href="#" data-toggle="modal" data-target="#exampleModal" onclick="empWalletDetails('<%= employer.getCompanyPublicId()%>')">Wallet</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
