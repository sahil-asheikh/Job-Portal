                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control form-control-sm" id="txtSubscription" type="text" name="txtSubscription" placeholder=""  value="<%=  employer.getSubscription()%>">
                                                        </div>
                                                    </div>
                                                     </div>
                                                  ...
                                                  <div class="form-row">
                                                   ...
                                                   <div class="col-md-6">
                                                        ...
                                                        <textarea class="form-control form-control-sm" id="txtJobAddress" name="txtJobAddress"><%=  employer.getJobAddress()%></textarea>
                                                        </div>
                                                   </div>
                                       </div>  
                                                <div class="row pt-3">
