                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <table class="table table-sm table-striped">
                                                <tbody>
                                                    <tr>
                                                        <td class="item mdi mdi-format-align-justify"> Job Description<span class="icon s7-phone"></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <textarea class="form-control bg-white" rows="8" readonly=""><%= vacancy.getJobDescription()%></textarea>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
