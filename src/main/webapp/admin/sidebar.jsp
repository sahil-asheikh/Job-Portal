            ...
            <div class="left-sidebar-scroll">
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                        ...
                        <li class="<%= (pageName.equals("adminDash")) ? "active" : ""%>"><a href="adminDash.jsp"><i class="icon mdi mdi-home"></i><span>Dashboard</span></a>
                        </li>
                          <li class="parent <%= (pageName.equals("subscription") || (pageName.equals("subscriptionSelect"))) ? "active" : ""%>"><a href="#"><i class="fa fa-credit-card"></i><span>&nbsp;Subscription</span></a>
                            <ul class="sub-menu">
                                <li class="<%= (pageName.equals("subscription")) ? "active" : ""%>"><a href="subscription.jsp">Add Subscription</a>
                                </li>
                                <li class="<%= (pageName.equals("subscriptionSelect")) ? "active" : ""%>"><a href="subscriptionSelect.jsp">Show Subscription</a>
                                </li>
                        ...
                        <li class="parent"><a href="#"><i class="fa fa-credit-card-alt"></i><span>&nbsp;Subscription Candidate</span></a>
                            <ul class="sub-menu">
                                <li class="<%= (pageName.equals("subscriptionCandidate")) ? "active" : ""%>"><a href="subscriptionCandidate.jsp">Add Subscription</a>
                                </li>
                                <li class="<%= (pageName.equals("subscriptionCandidateSelect")) ? "active" : ""%>"><a href="subscriptionCandidateSelect.jsp">Show Subscription</a>
                                </li>
                            ...
                            <ul class="sub-menu">
                                <li class="<%= (pageName.equals("candidateSetting")) ? "active" : ""%>"><a href="candidateSetting.jsp">&nbsp;Candidate Setting</a>
                                </li>
                        ...
                        <li class="parent"><a href="#"><i class="icon mdi mdi-card-membership"></i><span>Newsletter</span></a>
                           <ul class="sub-menu">
                                <li class="<%= (pageName.equals("showNotifyMe")) ? "active" : ""%>"><a href="showNotifyMe.jsp">Show Subscriber</a>
                                </li>
