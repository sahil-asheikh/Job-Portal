<%-- 
    Document   : showNotifyMe
    Created on : 5 Oct, 2020, 3:44:04 PM
    Author     : Zoya
--%>

<%@page import="com.qt.jobportal.beans.TblNotify"%>
<%@page import="com.qt.jobportal.models.NotifyMe"%>
...
<html lang="en">
    ...
    <body>
        <%
            ...
            ArrayList<TblNotify> notifyBean = notifyme.select();
        %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card card-table">
                                <div class="card-header">Newsletter Subscribers      
                                ...
                                <div class="card-body">
                                    <table class="table table-striped table-hover table-fw-widget" id="table3">
                                        ...
                                        <%  for (TblNotify notify : notifyBean) {
                                                if (notify.getSerialNo()== -1) {
                                        ...
                                        <tr>
                                            ...
                                            <%
                                            } else if (notify.getSerialNo() == 0) {

                                            %>
                                        <tr>
                                            <td> <%=  notify.getException()%>   </td>
                                        </tr>
                                        <%
                                        } else {
                                        %>
                                        <tbody>
                                            <tr>
                                                <td><%=  notify.getSerialNo()%></td>
                                                <td><%=  notify.getName()%></td>
                                                <td><%=  notify.getEmailId()%></td>
                                                <td><%=  notify.getJobCategory()%></td>
                                                <td><%=  notify.getCreatedAt() %></td>
                                                <td> <div class="btn-group btn-space">                                              
                                                        <button class="btn btn-sm btn-danger" type="button" title="Delete">  <a href="../NotifyController?action=delete&nid=<%= notify.getNotifyPublicId()%>"><div class="icon-sm"><span class="mdi mdi-delete"></span></div></a></button>
