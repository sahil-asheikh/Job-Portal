                                    ...
                                    <div class="col-sm-6">
                                        <div class="widget widget-tile bg-info ">
                                            ...
                                            <div class="data-info">
                                                ...
                                                <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right text-light"></span><span class="number" data-toggle="counter" data-end="113">100</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="widget widget-tile bg-info">
                                            ...
                                            <div class="data-info">
                                                ...
                                                <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right text-light"></span><span class="number" data-toggle="counter" data-end="113">50</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="widget widget-tile bg-info">
                                            ...
                                            <div class="data-info">
                                                ...
                                                <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right text-light"></span><span class="number" data-toggle="counter" data-end="113">70</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="widget widget-tile bg-info">
                                            ...
                                            <div class="data-info">
                                                ...
                                                <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right text-light"></span><span class="number" data-toggle="counter" data-end="113">90</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="pricing-table pricing-table-primary">
                        ...
                        <ul class="pricing-table-features">
                            <li class="blueEffect2">5 Jobs Posting</li>
                ...
                <div class="col-sm-3">
                    <div class="pricing-table pricing-table-warning">
                        <div class="pricing-table-title yellowEffect">Premium</div>
                        <div class="card-divider card-divider-xl"></div>
                        ...
                        <div class="card-divider card-divider-xl"></div>
                        <ul class="pricing-table-features">
                            <li class="yellowEffect2">5 Jobs Posting</li>
                            <li class="yellowEffect2">2 Featured jobs</li>
                            <li class="yellowEffect2">1 Renew Jobs</li>
                            <li class="yellowEffect2">10 Days Duration</li>
                            <li class="yellowEffect2">Email Alert</li>
                        </ul><a class="btn btn-outline-warning" href="#">Get Started</a>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="pricing-table pricing-table-success">
                        <div class="pricing-table-title greenEffect">Pro</div>
                        <div class="card-divider card-divider-xl"></div>
                        <div class="pricing-table-price "><span class="currency">&#8377;</span><span class="value greenEffect">18</span><span class="frecuency">/mo</span></div>
                        <div class="card-divider card-divider-xl"></div>
                        <ul class="pricing-table-features">
                            <li class="greenEffect2">5 Jobs Posting</li>
                            <li class="greenEffect2">2 Featured jobs</li>
                            <li class="greenEffect2">1 Renew Jobs</li>
                            <li class="greenEffect2">10 Days Duration</li>
                            <li class="greenEffect2">Email Alert</li>
                        </ul><a class="btn btn-outline-success" href="#">Get Started</a>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="pricing-table pricing-table-danger">
                        <div class="pricing-table-title redEffect">Team</div>
                        <div class="card-divider card-divider-xl"></div>
                        <div class="pricing-table-price "><span class="currency">&#8377;</span><span class="value redEffect">25</span><span class="frecuency">/mo</span></div>
                        <div class="card-divider card-divider-xl"></div>
                        <ul class="pricing-table-features">
                            <li class="redEffect2">5 Jobs Posting</li>
                            <li class="redEffect2">2 Featured jobs</li>
                            <li class="redEffect2">1 Renew Jobs</li>
                            <li class="redEffect2">10 Days Duration</li>
                            <li class="redEffect2">Email Alert</li>
                        </ul><a class="btn btn-outline-danger" href="#">Get Started</a>
                    </div>
                </div>
            </div>
            <!--plans ends here-->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3 col-sm-12">
                            <div class="row">
                                <div class="col-sm-2">
                                    <i class="fa fa-bell pr-4 pt-4" style="font-size:30px"></i>
                                </div>
                                <div class="col-sm-10  p-4">
                                    <a href="#" class="text-dark">Get Jobs Notifications</a><br>
                                    <a href="#" class="text-muted">Free Subscribe Our Newsletter Now</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-6">
                                    <form>
                                        <div class="form-group">
                                            <input type="text" class="form-control mt-3" id="comment" placeholder="Enter Your Category"></textarea>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-6">
                                    <form>
                                        <div class="form-group">
                                            <input type="email" class="form-control mt-3" id="comment" placeholder="Enter Your Email"></textarea>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-sm-12">
                            <a class="btn btn-lg btn-primary btn-block mt-3" href="#">Submit</a>
                        </div>
                    </div>
