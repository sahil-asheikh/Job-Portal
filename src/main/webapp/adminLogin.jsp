                    ...
                    <div class="splash-container">
                        <div class="card card-border-color card-border-color-primary">
                            <div class="card-header "><!--<img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="{conf.logoWidth}" height="27">-->
                                ...
                                <span class="splash-description">${param.msg}</span>
                                <span class="splash-description">${param.message}</span>
                            </div>
                            <div class="card-body">
                                <form method="get" action="AdminController" name="frm">
                                    ...
                                    <div class="login-form">
                                        <div class="form-group">
                                            <input class="form-control" id="txtPhoneNo" type="text" name="txtPhoneNo" placeholder="Username" autocomplete="off" required="">
                                        </div>
                                        <div class="form-group">
