<%-- 
    ...
    Created on : 12 Oct, 2020, 12:13:37 PM
    Author     : Zoya
--%>
...
<html>
    <head>
        ...
        <script src="../assets/myjs/forgetPassVali.js" type="text/javascript"></script>
    </head>
                         ...
                         <div class="card card-contrast">
                            ...
                            <div class="card-body">
                                <form method="post" action="../ResetPasswordController" name="frm">
                                    <input type="hidden" name="action" value="candidateMobile">
