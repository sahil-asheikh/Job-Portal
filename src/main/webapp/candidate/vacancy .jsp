            ...
            function keySkillChange() {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState === 4 && this.status === 200) {
                        document.getElementById("dyamicSkill").innerHTML =
                                this.responseText;
                    }
                };
             ...
             //Checkbox [skilsset]                
                ...
                function showCheckboxes() {
                    var checkboxes = document.getElementById("dyamicSkillStyle");
                    if (!expanded) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-border-color card-border-color-primary">
                            ...
                            <div class="card-body">
                                <form action="../VacancyController" method="post" name="frm">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div id="dyamicSkillStyle">
                                                <div id="dyamicSkill"> </div>
                                                </div>
                                        </div>
                                    </div>
                                         <div class="col-md-12">
