<%-- 
    Document   : appliedJob
    Created on : 28 Mar, 2020, 7:19:47 PM
    Author     : Zoya
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            ArrayList<TblJobActivity> apply = jobAct.selectByCandidate(1,String.valueOf(session.getAttribute("CandidateId")));
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="button-group">
                                                        ...
                                                        <button class="btn btn-outline-danger"><a href="../JobActivityController?action=delete&id=<%= bean.getId() %>">Delete</button>
