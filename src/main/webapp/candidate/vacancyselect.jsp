                                                ...
                                                <td colspan="3">
                                                    <div class="btn-group btn-space">         
                                                        <button class="btn btn-secondary btn-sm btn-primary" type="button" data-toggle="modal" data-target="#exampleModalCenter"> 
                                                            <a href="viewMore.jsp?id=<%= vacancy.getId()%>"
                                                            <div class="icon-sm">
                                                        ...
                                                        <button class="btn btn-secondary btn-sm btn-warning " type="button">
                                                            <a href="vacancyupdate.jsp?id=<%= vacancy.getId()%>">
                                                                <div class="icon-sm">
                                                        ...
                                                        <a class="btn btn-secondary btn-sm btn-danger" href="../VacancyController?action=delete&id=<%= vacancy.getId()%>">
