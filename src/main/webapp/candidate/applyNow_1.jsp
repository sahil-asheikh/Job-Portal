...
<%
   ...
   %>   
                            ...
                            <div class="col-6"><a class="btn btn-primary btn-xl" href="TransactionController?action=apply&id=<%= vacancy.getId()%>&candidateid=<%= beanCandidate.getId()%>&deduction=30&deduction_type=1&employer_id=<%= vacancy.getEmployerId() %>&empDeduction=20&empdeduction_type=2&empname=<%= vacancy.getCompanyName() %>&jobtitle=<%= vacancy.getTitle()%>"  data-dismiss="modal"  >Apply Now</a></div>
                            <%
                                }else{
