                                    ...
                                    <table class="table table-bordered table-hover table-fw-widget table-sm" id="table3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=  candidateBean.getGender()%></td>
                                                <td><%=  candidateBean.getQualification()%></td>
                                                <td><%=  candidateBean.getSchoolMedium()%></td>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-space">         
                                                        <button class="btn btn-secondary btn-sm btn-primary" type="button" data-toggle="modal" data-target="#exampleModalCenter"> 
                                                          <a href="candidateView.jsp?id=<%= candidateBean.getId()%>">
                                                        ...
                                                        <button class="btn btn-secondary btn-sm btn-warning " type="button">
                                                            <a href="candidateUpdate.jsp?id=<%= candidateBean.getId()%>">
                                                                <div class="icon-sm">
                                                        ...
                                                        <a class="btn btn-secondary btn-sm btn-danger" href="../CandidateController?action=delete&id=<%= candidateBean.getId()%>">
